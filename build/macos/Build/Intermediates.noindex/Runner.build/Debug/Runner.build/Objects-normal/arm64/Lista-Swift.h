...
#ifndef LISTA_SWIFT_H
#define LISTA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Lista",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Lista11AppDelegate")
...
SWIFT_CLASS("_TtC5Lista17MainFlutterWindow")
